...
/** Class to implement the mortgage property pop up of the GUI, containing 
...
public class MortgagePropertyPanel extends JPanel implements ActionListener {
	...
	public MortgagePropertyPanel(MonopolyGUI gui, Monopoly game) {
		super();
		_gui = gui;
        _game = game;
   ...
   @Override
    ...
    /** Draws the Graphics JButtons */
    private void drawButtons(Graphics2D g) {
    	JButton mortgage = new JButton("Mortgage/Unmortgage Property");
    	mortgage.setLocation(500, 200);
    	mortgage.setSize(250, 50);
